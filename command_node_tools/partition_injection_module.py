...
# Set SUT directory paths
sut_dir = sut_config.sut_dir
sut_logs_path = os.path.join(sut_dir, sut_config.sut_logs_path)
final_logs_path = os.path.join(slicify_config.comm_logs_path, "final.txt")
tests_logs_path = os.path.join(sut_dir, "tests_logs")
